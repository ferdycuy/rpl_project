...
<div class="row">
    ...
    <!-- <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-shopping-bag"></i> Nama Produk</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <!-- <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-box"></i> Stok Produk</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <!-- <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-shopping-cart"></i> Telah Terjual</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <!-- <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-tags"></i> Kategori Produk</h6>
            </div>
            <div class="card-body">
                <center>
