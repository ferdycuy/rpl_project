	...
	<div class="row">
		<div class="col-sm-4">
			<div class="card card-primary mb-3">
				...
				<div class="card-body">
					<input type="text" id="cari" class="form-control" name="cari" placeholder="Masukan : Nama Produk/Kode ">
				</div>
			</div>
		</div>
		<div class="col-sm-8">
			...
			<div class="card card-primary">
				<div class="card-header bg-primary text-white">
					...
					<a class="btn btn-danger float-right" 
						onclick="javascript:return confirm('Yakin ingin mereset keranjang ?');" href="fungsi/hapus/hapus.php?penjualan=jual">
